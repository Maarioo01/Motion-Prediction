        ...
        for data_file in self.data_files:
            ...
            for data in dataset:
                ...
                for int_id in objects_of_interest:
                    # objects_of_interest isn't guaranteed to be a subset of
                    # tracks_to_predict for every scenario - skip ids that aren't
                    # prediction targets rather than crashing (interactive_process only
                    # does membership checks on this list, order/length don't matter).
